...
import { addProduct } from "@/Redux/productsReduce";
  ...
  const submitForm = async (event) => {
    ...
    dispatch(
      ...
      if (action.meta.requestStatus === "fulfilled") {
        notify(1, "Produit ajouté avec succès !");
                  ...
                  <Row>
                    <Col md="12">
                      <Form onSubmit={submitForm}>
                        <Card>
                          <Card.Header>
                            <Card.Title as="h4">{"Ajouter un produit"}</Card.Title>
                          </Card.Header>
                          <Card.Body>
                            <Row>
                              ...
                              <Col className="pl-1" md="6">
                                <Form.Group>
                                  ...
                                  <Form.Control
                                    ...
                                    rows={3}       // Add this to set the initial height
                                    value={description}
