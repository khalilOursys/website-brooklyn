...
export default function Page() {
    ...
    },
    {
      ...
      Cell: ({ cell }) => (
        <div className="actions-right block_action">
          <Button
            onClick={() => {
              router.push("/admin/bulkProducts/edit/" + cell.row.original.id);
            }}
            variant="warning"
            size="sm"
          ...
          <Button
            onClick={() => router.push("/admin/bulkProducts/detail/" + cell.row.original.id)}
            variant="info"
            size="sm"
  ...
  function ajouter() {
    router.push("/admin/bulkProducts/add");
  }
