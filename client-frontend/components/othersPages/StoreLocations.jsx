        ...
        <div className="row widget-tabs">
          <div className="col-xl-4 col-md-5 col-12">
            <div className="tf-store-list d-flex gap-10 flex-column widget-menu-tab">
              <div
                className={`tf-store-item item-title ${activeTab == 1 ? "active" : ""
                  }  default`}
              ...
              <div
                className={`tf-store-item item-title ${activeTab == 2 ? "active" : ""
                  }  default`}
              ...
              <div
                className={`tf-store-item item-title ${activeTab == 3 ? "active" : ""
                  }  default`}
              ...
              <div
                className={`tf-store-item item-title ${activeTab == 4 ? "active" : ""
                  }  default`}
